<?php
  ...
  $id = $_GET['id'];
  $result_usuario = "SELECT * FROM locacao WHERE id='$id'";
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Editar Locação</li>
              ...
              <form name="form" data-toggle="validator" role="form" method="POST" action="alterar_locacao.php">
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="dataLocacao" aria-describedby="emailHelp" name="dataLocacao" placeholder="Digite o valor da locação do carro" data-error="Por favor, informe o valor da locação" required value="<?php echo $row_usuario['dataLocacao']; ?>">
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="dataDevolucao">Data da Devolução</label>
                    <input type="date" class="form-control" id="dataDevolucao" aria-describedby="emailHelp" name="dataDevolucao" placeholder="Digite o valor da locação do carro" data-error="Por favor, informe o valor da locação" required value="<?php echo $row_usuario['dataDevolucao']; ?>">
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="quilometragem">Quilometragem</label>
                    <input type="text" class="form-control" id="quilometragem" aria-describedby="emailHelp" name="quilometragem" placeholder="Digite o valor da locação do carro" data-error="Por favor, informe o valor da locação" required value="<?php echo $row_usuario['quilometragem']; ?>">
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group">
                    <label for="cor">Cor</label>
                    <input type="text" class="form-control" id="cor" aria-describedby="emailHelp" name="cor" placeholder="Digite o valor da locação do carro" data-error="Por favor, informe o valor da locação" required value="<?php echo $row_usuario['cor']; ?>">
                    <div class="help-block with-errors"></div>
                  </div>
