...
<html lang="pt-br">
  ...
  <head>
    ...
    <title>Editar Funcionário - LocaPlus</title>
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Cadastrar Cliente</li>
              ...
              <form name="form" method="POST" action="alterar_funcionario.php">
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="dataadmissao" aria-describedby="emailHelp" name="dataadmissao" placeholder="Digite a CNH do cliente" value="<?php echo $row_usuario['dataadmissao']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="datademissao">Data de Demissão</label>
                    <input type="date" class="form-control" id="datademissao" aria-describedby="emailHelp" name="datademissao" placeholder="Digite o valor da locação do carro" data-error="Por favor, informe o valor da locação" required value="<?php echo $row_usuario['datademissao']; ?>">
                    <div class="help-block with-errors"></div>
                  </div>
                  <button type="submit" id="btnCadAutomovel" class="btn btn-primary" name="editar_funcionario">Salvar</a></button>
  </form> 
