...
showSymbol:true, thousands:'.', decimal:',', symbolStay: true});
  ...
  <head>
    ...
    <title>Editar Conta - LocaPlus</title>
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Editar Automóvel</li>
                ...
                <form name="form" method="POST" action="alterar_conta.php">
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="valor" aria-describedby="emailHelp" name="valor" placeholder="Digite o valor da conta" data-error="Por favor, informe o valor da locação" required value="<?php echo $row_usuario['valor']; ?>">
                      </div>
                          <div class="form-group">
                        <label for="dataVencimento">Data de Vencimento</label>
                        <input type="date" class="form-control" id="dataVencimento" aria-describedby="emailHelp" name="dataVencimento" data-error="Por favor, informe o valor da locação" required value="<?php echo $row_usuario['dataVencimento']; ?>">
                      </div>
                      <div class="form-group">
                        <label for="dataPagamento">Data de Pagamento</label>
                        <input type="date" class="form-control" id="dataPagamento" aria-describedby="emailHelp" name="dataPagamento" data-error="Por favor, informe o valor da locação" required value="<?php echo $row_usuario['dataPagamento']; ?>">
                      </div>
                      <div class="form-group">
                        <label for="observacao">Observação</label>
                        <input type="text" class="form-control" id="observacao" aria-describedby="emailHelp" name="observacao" placeholder="Digite a observacao (opcional)" data-error="Por favor, informe o valor da locação" required value="<?php echo $row_usuario['observacao']; ?>">
                      </div>
                      <div class="form-group">
                        <label for="status">Status</label> </br>
                        <label><input type="radio" name="status" value="Pago" checked>Pago</label> </br>
